...
echo %c_title%  Build Gallery Images%c_reset%
echo %c_title%========================================%c_reset%
echo.
...
if not defined source (
    echo Enter the folder containing PNGs.
    echo.
...
powershell -ExecutionPolicy Bypass -File "%~dp0build_gallery_images.ps1" -input_dir "%source%"
